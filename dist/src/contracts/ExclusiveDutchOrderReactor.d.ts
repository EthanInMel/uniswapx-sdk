...
export declare type FillEvent = TypedEvent<[
    string,
    string,
    string,
    BigNumber
...
export declare type ProtocolFeeControllerSetEvent = TypedEvent<[
    string,
    string
], ProtocolFeeControllerSetEventObject>;
export declare type ProtocolFeeControllerSetEventFilter = TypedEventFilter<ProtocolFeeControllerSetEvent>;
