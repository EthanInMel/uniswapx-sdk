...
export declare type CosignerDataJSON = {
    decayStartTime: number;
    decayEndTime: number;
    exclusiveFiller: string;
...
export declare type UnsignedV2DutchOrderInfo = OrderInfo & {
    cosigner: string;
    input: DutchInput;
    outputs: DutchOutput[];
};
export declare type CosignedV2DutchOrderInfo = UnsignedV2DutchOrderInfo & {
...
export declare type CosignedV2DutchOrderInfoJSON = UnsignedV2DutchOrderInfoJSON & {
